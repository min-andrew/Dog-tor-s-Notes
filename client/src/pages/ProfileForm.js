  ...
  return (
    ...
    <Container style={containerStyle}>
        ...
        <div className="profile-page">
            <Header style={headerStyle} className="">Please Add Your Dog's Profile Here</Header>
            <div style={cardStyle}>
        ...
        <div>{addError && <div className="">{addError.message}</div>}</div>
      </div>
      ...
      <Link to="/profiles">
          <Button primary className='vet-form-nav-btns'>Back to Profiles</Button>
        </Link>
